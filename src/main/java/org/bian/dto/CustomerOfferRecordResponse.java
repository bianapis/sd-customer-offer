...
/**
 * CustomerOfferRecordResponse
 */
public class CustomerOfferRecordResponse   {
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier general-info: Recording Record 
